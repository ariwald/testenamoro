...
export default function Friends() {
    ...
    const friends = useSelector(
        state =>
            ...
            state.friendsWannabes.filter(
                friendWannabe => friendWannabe.accepted
            )
    );
    ...
    return (
        <div>
            <p id="titleFindPeople">Friends</p>
                ...
                {friends &&
                    friends.map(friendWannabe => (
                        <div id="bottomFindPeople" key={friendWannabe.id}>
                            ...
                            <button
                                onClick={e =>
                                    dispatch(unfriend(friendWannabe.id))
                                }
                            >
                                {" "}
                                end friendship{" "}
            ...
            <p id="titleFindPeople">Friend requests</p>
            <div className="friendsContainer">
                {invitations &&
                    invitations.map(friendWannabe => (
                        <div id="bottomFindPeople" key={friendWannabe.id}>
                            ...
                            <button
                                onClick={e =>
                                    dispatch(
                                        acceptFriendRequest(friendWannabe.id)
                                    )
                                }
                            >
                                {" "}
